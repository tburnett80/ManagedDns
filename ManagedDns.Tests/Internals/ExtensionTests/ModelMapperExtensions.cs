...
namespace ManagedDns.Tests.Internals.ExtensionTests
{
    ...
    public class ModelMapperExtensions
    {
        ...
        public void TestResourceRecordConversion()
        {
            ...
            Assert.Equal((msg.Record as Internal.Model.RData.TxtRecord).Text, (model.Record as TxtRecord).Text);
        ...
        public void TestMessageConversion()
        {
            ...
            Assert.Equal((msg.Answers.FirstOrDefault().Record as Internal.Model.RData.TxtRecord).Text, (model.Answers.FirstOrDefault().Record as TxtRecord).Text);
