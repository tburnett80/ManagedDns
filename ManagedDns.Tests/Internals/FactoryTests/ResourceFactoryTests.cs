...
namespace ManagedDns.Tests.Internals.FactoryTests
{
    ...
    public class ResourceFactoryTests
    {
        ...
        public void FactoryResourceRecordAAAA()
        {
            ...
            Assert.Equal("2607:f8b0:4009:800::1006", resourceRecord.Record.DataAsString());
        ...
        public void FactoryResouceRecordA()
        {
            ...
            Assert.Equal("206.190.36.45", resourceRecord.Record.DataAsString());
        ...
        public void FactoryResouceRecordMx()
        {
            ...
            Assert.Equal((uint)1800, resourceRecord.Ttl);
            Assert.Equal("1 - mta7.am0.yahoodns.net.", resourceRecord.Record.DataAsString());
        ...
        public void FactoryResouceRecordPtr()
        {
            ...
            Assert.Equal("dfw06s40-in-f21.1e100.net.", resourceRecord.Record.DataAsString());
        ...
        public void FactoryResouceRecordSoa()
        {
            ...
            Assert.Equal((uint)1800, resourceRecord.Ttl);
            Assert.Equal(string.Empty, resourceRecord.Record.DataAsString());
